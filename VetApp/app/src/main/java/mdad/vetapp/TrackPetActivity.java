...
public class TrackPetActivity extends AppCompatActivity {
    ...
    class GetPet extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TrackPetActivity.this);
...
//                        map.put("pet_dob", pet_dob);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_trackpet, menu);
        return true;
    }

    public boolean onOptionsItemSelected(MenuItem item) {
        Intent i = new Intent(getApplicationContext(), RegisterPetActivity.class);
        startActivity(i);
        return true;
    }
}